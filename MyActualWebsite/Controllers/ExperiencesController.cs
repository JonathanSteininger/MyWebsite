    ...
    public class ExperiencesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var experience = await _context.Experience
                .FirstOrDefaultAsync(m => m.ExperienceKey == id);
            if (experience == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("ExperienceKey,Shown,CompanyName,link,StartDate,EndDate,Position,Body")] Experience experience)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ExperienceExists(experience.ExperienceKey))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
          return (_context.Experience?.Any(e => e.ExperienceKey == id)).GetValueOrDefault();
        }
    }
}
